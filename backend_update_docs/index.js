...
const corsOptions = {
    ...
    methods: ['GET', 'PUT', 'PATCH'], // Métodos HTTP permitidos
...
app.patch('/api/docs/:id/edit', async(req, res, next) => {
  await update(req.body, req.params['id']);
  io.emit('mensaje', `The ${req.body.titulo} document was updated successfully`);
